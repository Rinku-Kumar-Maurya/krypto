            ...
            <div className="flex flex-col items-center w-full mt-3">
                <div className="w-full p-2 mb-6">
                    ...
                    <a href={`https://ropsten.etherscan.io/address/${addressTo}`} target="_blank" rel="noopner noreferrer">
                        <p className="text-white text-base">To: {shortenString(addressTo)}</p>
                    </a>
                ...
                <img
                    src={gifUrl || url}
                    alt="gif"
                    className="w-full h-96 2xl:h-96 rounded-md shadow-lg object-cover"
                />
        ...
        <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
            <div className="flex flex-col md:p-12 py-12 px-4">
                {currentAccount ? (
                    ...
                    <h1 className="text-white text-3xl text-center my-2">Connect your Wallet to see latest transactions</h1>
                )}
